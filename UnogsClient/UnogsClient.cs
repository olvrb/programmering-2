...
namespace UnogsClient
{
    public class UnogsClient {
        ...
        public ApiItem GetTitleByName(string name) {
            // Generate code because of dumb undocumented api that i don't have to to reverse, generated by RapidAPI...
            client = new RestClient($"https://unogs-unogs-v1.p.rapidapi.com/aaapi.cgi?q=get%3A{name}-!1900%2C2019-!0%2C5-!0%2C10-!0-!Any-!Any-!Any-!gt100-!%7Bdownloadable%7D&t=ns&cl=all&st=adv&ob=Relevance&p=1&sa=and");
