    ...
    public class Library
    {
        ...
        public void Populate()
        {
            AddTitle(new Show("Brooklyn Nine Nine",
                ...
                ImageFromUrl("https://m.media-amazon.com/images/M/MV5BMGU3NGYyYTYtYjIzMS00ZmUwLTlmMjAtZDhhMzFiNWI0NzNkXkEyXkFqcGdeQXVyMzQ2MDI5NjU@._V1_.jpg"),
                new List<Season> {
                    new Season(new List<Episode> {
                        new Episode("Pilot", "Detective Jake Peralta is a talented, but carefree police detective at Brooklyn's ninety-ninth precinct who, along with his eclectic group of colleagues, are used to having a lax captain around the office. However, when tightly-wound Captain Ray Holt takes over, he is determined to make this dysfunctional group of detectives into the best precinct in Brooklyn.", 10)
                    })
                }));
            AddTitle(new Movie("How the Grinch Stole Christmas",
                new List<Rating> { new Rating(10) },
                ImageFromUrl("http://t3.gstatic.com/images?q=tbn:ANd9GcT-oosslYzD61pdLgPVmjN53hdzb-bjBeJajr2UILlq7kQNz7jR"),
                100));
        }
